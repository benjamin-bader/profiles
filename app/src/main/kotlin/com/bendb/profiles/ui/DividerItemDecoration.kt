...
class DividerItemDecoration : RecyclerView.ItemDecoration {
    companion object {
        @JvmStatic val ATTRS = intArrayOf(android.R.attr.listDivider)
    ...
    constructor(context: Context, orientation: Int, paddingStart: Float, rtl: Boolean): super() {
        this.rtl = rtl
  ...
  fun drawVertical(c: Canvas, parent: RecyclerView) {
    val left = (parent.paddingLeft + (if (rtl) 0.0f else paddingStart)).toInt()
